...
/** The Mod operation. */
public class ModOperationOptimizedCandidate extends AbstractFixedCostOperation {
   ...
   */
  public ModOperationOptimizedCandidate(final GasCalculator gasCalculator) {
  ...
  public static OperationResult staticOperation(final MessageFrame frame) {
    ...
    if (value1.isZero()) {
      ...
      UInt256 b0 = UInt256.fromBytesBECandidate(value0.toArrayUnsafe());
      UInt256 b1 = UInt256.fromBytesBECandidate(value1.toArrayUnsafe());
